...
public record UpdateIssueRequest(
        @NotBlank(message = "Title is required", groups = ValidationGroups.Put.class)
        ...
        @NotBlank(message = "Issue type is required", groups = ValidationGroups.Put.class)
        IssueType type,

        @NotBlank(message = "Priority is required", groups = ValidationGroups.Put.class)
